...
export class Employee {
  constructor(data = {}) {
    ...
    this.name = data.name || '';
    this.birth_date = data.birth_date || data.birth || '';
    this.department = data.department || '';
    this.position = data.position || '';
    this.hire_date = data.hire_date || '';
    this.mitmas_career = data.mitmas_career || data.eus_career || '';
    ...
    this.photo = data.photo || data.photoUrl || null;
  ...
  toJSON() {
    return {
      ...
      mitmas_career: this.mitmas_career,
      total_career: this.total_career,
      email: this.email,
      phone: this.phone,
