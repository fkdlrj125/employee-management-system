...
class EmployeeApiService {
  ...
  async getEvaluationHistory(employeeId, year = null) {
    try {
      ...
      // 404 등 실제 API가 없을 때 더미 데이터 반환
      // 연도별 6개 점수, 3년치 더미
      const dummy = [
        {
          evaluation_date: `${new Date().getFullYear() - 2}-12-31`,
          score1: 3, score2: 3, score3: 3, score4: 3, score5: 3, score6: 3,
        },
        {
          evaluation_date: `${new Date().getFullYear() - 1}-12-31`,
          score1: 4, score2: 4, score3: 4, score4: 4, score5: 4, score6: 4,
        },
        {
          evaluation_date: `${new Date().getFullYear()}-12-31`,
          score1: 5, score2: 5, score3: 5, score4: 5, score5: 5, score6: 5,
        },
      ];
      return dummy;
    }
